...
import (
	...
	"github.com/borysbabii/Go-Clean-Architecture-REST-API/internal/server"
	"github.com/borysbabii/Go-Clean-Architecture-REST-API/pkg/db/aws"
	"github.com/borysbabii/Go-Clean-Architecture-REST-API/pkg/db/postgres"
	"github.com/borysbabii/Go-Clean-Architecture-REST-API/pkg/db/redis"
...
// @contact.name Borys Babii
// @contact.url https://github.com/borysbabii
// @contact.email angelus169@gmail.com
// @BasePath /api/v1
func main() {
